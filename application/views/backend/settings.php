                ...
                <div class="wrapper row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <label for="enable-double">
                                Activer le double réservation
                            </label><br/>
                            <button type="button" id="enable-double" class="btn btn-default" data-toggle="button" aria-pressed="false">
                                <span class="glyphicon glyphicon-duplicate"></span> Permettre double réservation</button>
                        </div>
                        <div class="form-group">
                            <label for="enable-google">
                                Activer synchroniseur google calendar
                            </label>				
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            <label for="show-provider">
                                Permettre au client de voir la liste des fournisseurs
                            </label>				
