...
class Backend extends CI_Controller {
	...
	$view['number_appointment_projected'] = $this->appointments_model->get_count_projected();
	$view['number_appointment_confirmed'] = $this->appointments_model->get_count_confirmed();
	$view['number_appointment'] = $this->appointments_model->get_count();
        $view['number_appointment_price'] = $this->appointments_model->get_count_price();
        $view['base_url'] = $this->config->item('base_url');
        $view['user_display_name'] = $this->user_model->get_user_display_name($this->session->userdata('user_id'));
