...
class Secretaries_Model extends CI_Model {
    ...
    public function insert($secretary) {
        ...
        $secretary['id_roles'] = $this->get_secretary_role_id();
         $secretary['salt'] = generate_salt();
        $secretary['password'] = hash_password($secretary['salt'], $secretary['password']);
    ...
    public function update($secretary) {
        ...
        if (isset($secretary['password'])) {
            $salt = $this->db->get_where('ea_users', array('id' => $secretary['id']))->row()->salt;
            $secretary['password'] = hash_password($salt, $secretary['password']);
        }
    ...
    public function validate($secretary) {
        ...
        /*if (isset($secretary['username'])) {
            $user_id = (isset($secretary['id'])) ? $secretary['id'] : '';
            if (!$this->validate_username($secretary['username'], $user_id)) {
        ...
        if (isset($secretary['password'])) {
            if (strlen($secretary['password']) < MIN_PASSWORD_LENGTH) {
