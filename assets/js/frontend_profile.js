...
*/
 $(document).on('keypress', '#last_name ,#first_name ,#email , #phone-number ', function() {
  ...
  $(document).on('click', '#canceal-update-new-phone', function() {$('.ajout-input-phone').removeClass('hidden');
    ...
    $(document).on('click', '#canceal-update-info', function() {   $('.edit-info').addClass('hidden');
                                                                   $('.info').removeClass('hidden');
                                                               
                                                               $('#update-info').show();

                       });
  $(document).on('click', '.ajout-input-phone', function() {$('.ajout-input-phone').addClass('hidden');
    ...
    $('#last_name').focus();
        ...
        if (  GlobalVariables.customer.mobile_number)
           { $('.mobile-number').removeClass('hidden'); 
             ...
             else{ $('.mobile-number').addClass('hidden'); 
             }
...
if(missingRequiredField) {event.preventDefault();
}
...
****************************************************/
  ...
  $(document).on('click', '#canceal-update-new-address', function() {$('.ajout-input-address').removeClass('hidden');
    ...
    $(document).on('click', '#canceal-update-address', function() {   $('.edit-info-address').addClass('hidden');
  ...
  $(document).on('click', '.ajout-input-address', function() {$('.ajout-input-address').addClass('hidden');
