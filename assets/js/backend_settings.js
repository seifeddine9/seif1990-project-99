...
var BackendSettings = {
    ...
    initialize: function (bindEventHandlers) {
        ...
        if ($('#enable-double').hasClass('active') === false) {
            document.getElementById('company-service').disabled = true;
        } else {
            document.getElementById('company-service').disabled = false;
        }
    ...
    bindEventHandlers: function () {
        ...
        $('#enable-double').click(function () {
            if ($('#enable-double').hasClass('active') === true) {
                document.getElementById('company-service').disabled = true;
            } else {
                document.getElementById('company-service').disabled = false;
            }
...
SystemSettings.prototype.get = function () {
    ...
    settings.push({
        'name': 'enable_double',
        'value': $('#enable-double').hasClass('active') === true ? '1' : '0'
    });
