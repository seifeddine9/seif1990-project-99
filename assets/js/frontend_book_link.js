 ...
 *
 * @namespace FrontendBookLink
 */
var FrontendBookLink= {
    /**
    ...
    initialize: function(bindEventHandlers, manageMode) {
        ...
        FrontendBookLink.manageMode = manageMode;
        ...
        $('#select-date').datepicker({
            ...
            onSelect: function(dateText, instance) {
                FrontendBookLink.getAvailableHours(dateText);
                FrontendBookLink.updateConfirmFrame();
            }
        });
        ...
        if (bindEventHandlers) {
            FrontendBookLink.bindEventHandlers();
        }

        // If the manage mode is true, the appointments data should be
        // loaded by default.
        if (FrontendBookLink.manageMode) {
            FrontendBookLink.applyAppointmentData(GlobalVariables.appointmentData,
    ...
    bindEventHandlers: function() {
        ...
        $('#select-provider').change(function() {
            FrontendBookLink.getAvailableHours(Date.today().toString('dd-MM-yyyy'));
            FrontendBookLink.updateConfirmFrame();
        });
        ...
        $('#select-service').change(function() {
            ...
            FrontendBookLink.getAvailableHours($('#select-date').val());
            FrontendBookLink.updateConfirmFrame();
            FrontendBookLink.updateServiceDescription($('#select-service').val(), $('#service-description'));
        });
        ...
        $(document).on("click", '#button-next-2', function (event) {
            ...
            if ($('.selected-hour').length == 0) {
                ...
                if (jQuery.isEmptyObject(GlobalVariables.user_id))
                {
                    var nextTabIndex = parseInt($(this).attr('data-step_index')) + 1;
                ...
                } else if (GlobalVariables.user_id == GlobalVariables.customerData.id)
                {
                    ...
                    {
                        window.location = GlobalVariables.baseUrl + 'index.php/user/no_privileges';
  ...
  var postUrl = GlobalVariables.baseUrl + 'index.php/user/ajax_check_login_customer';
                var postData = {
                 ...
                 if (!FrontendBookLink.validateCustomerForm()) {
                return;
            }
  $.post(postUrl, postData, function (response) {
    console.log(response);
       if ((response.role_slug == "customer") && (response.user_id == GlobalVariables.customerData.id))
                {
                    FrontendBookLink.updateConfirmFrame();
                    ...
                    } else if (response.user_id != GlobalVariables.customerData.id)
                      {
                          window.location = GlobalVariables.baseUrl ;
        ...
        $('#book-appointment-submit').click(function(event) {
            FrontendBookLink.registerAppointment();
        });
    ...
    getAvailableHours: function(selDate) {
        ...
        var appointmentId = (FrontendBookLink.manageMode)
        ...
        var postData = {
            ...
            'manage_mode': FrontendBookLink.manageMode,
    ...
    updateConfirmFrame: function() {
        ...
        postData['appointment'] = {
            ...
            'end_datetime': FrontendBookLink.calcEndDatetime(),
            'notes': $('#notes').val(),
        ...
        postData['manage_mode'] = FrontendBookLink.manageMode;
